...
public abstract class Entity
{
    ...
    public WorldCamera worldCamera { get { return chunk.world.worldCamera; } }
    public ISOGame game { get { return chunk.game; } }
    ...
    public virtual void OnSpawn(Chunk chunk, Vector3 position)
    {
        ...
        if (ISOMain.doesDebugging)
        {
            ...
            world.worldCamera.AddDebugDrawable(debugLabel);
        }
    }
